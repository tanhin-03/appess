...
class BuyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val productPrice = productPriceString.removePrefix("VND ").replace(",", "").toDoubleOrNull() ?: 0.0

        productNameTextView.text = productName
        productPriceTextView.text = "VND $productPrice"
        ...
        val updateTotalPrice = {
            ...
            totalPriceTextView.text = "Total Price: VND $totalPrice"
        }
        updateTotalPrice()
